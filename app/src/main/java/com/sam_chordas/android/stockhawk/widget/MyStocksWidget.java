...
public class MyStocksWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setRemoteAdapter(R.id.widget_list,
                new Intent(context, MyStocksRemoteViewsService.class));
        ...
        views.setEmptyView(R.id.widget_list, R.id.no_stocks_message);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (StockTaskService.ACTION_PERIODIC_UPDATE.equals(intent.getAction())) {
